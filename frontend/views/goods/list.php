...
<head>
	...
	<link rel="stylesheet" href="/user_css/style/list.css" type="text/css">
	...
	<script type="text/javascript" src="/user_css/js/list.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
    <?php
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/user_css/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(['detail','id'=>$row->id])?>"><img src="<?=$row->logo?>" alt="" /></a></dt>
							<dd><a href=""><?=$row->name?></a></dt>
