...
<head>
	...
	<link rel="stylesheet" href="/user_css/style/goods.css" type="text/css">
	<link rel="stylesheet" href="/user_css/style/common.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/user_css/style/jqzoom.css" type="text/css">
	...
	<script type="text/javascript" src="/user_css/js/goods.js"></script>
	<script type="text/javascript" src="/user_css/js/jqzoom-core.js"></script>
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/user_css/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/user_css/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
<!--                        $goods->imgs[0]通过一对多获得的数据-->
						<a href="<?=$goods->imgs[0]->path."?imageView2/1/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goods->imgs[0]->path."?imageView2/1/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
...
<!--							商品详情介绍-->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/user_css/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/user_css/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/user_css/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
